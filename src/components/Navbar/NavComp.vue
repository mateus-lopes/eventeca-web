...
<template>
  <div>
    <section class="shadow-xl md:py-5 lg:py-3 bg-white">
      <header
        class="flex items-center container max-w-7xl mx-auto py-3 text-gray-600 m-0"
      >
        <div class="flex justify-between w-full items-center gap-8">
          ...
          <div class="flex items-center">
            ...
            <!-- btn user -->
            <BtnNav link="/profile" v-if="user"> Nome do User </BtnNav>
            <BtnNav link="/login" v-else> Entrar </BtnNav>
            <!-- btn mobile navbar -->
            <button
              @click="toogle_navbar"
