...
<script>
import Icon from '@/components/Reusables/Icon.vue';
    ...
    data() {
        return {
            navbar: {
                ...
                "text-light": (this.text_white ? this.text_white : false),
            },
            li_style: 'my-5 md:my-2 w-40 md:w-auto flex items-center gap-2'
        };
    },
    props: {
...
<style>
    ...
    .active::after {
        animation: mobile__nav .5s ease-out;
        content: '';
        display: block;
        width: 3px;
        height: 100%;
